...
export const INGREDIENTS = [
    ...
    // ─── OTROS / MISCELÁNEOS (Faltantes en auditoría) ─────────────────────
    { id: "res_molida_magra", name: "Res molida magra", category: "proteinas", aliases: ["carne molida"], seasonal: false, frequency: "alta" },
    { id: "tocino_magro", name: "Tocino magro", category: "proteinas", seasonal: false, frequency: "media" },
    { id: "pechuga_pollo", name: "Pechuga de pollo", category: "proteinas", seasonal: false, frequency: "alta" },
    { id: "atun_lata", name: "Atún en lata", category: "proteinas", seasonal: false, frequency: "alta" },
    { id: "bisonte", name: "Carne de bisonte", category: "proteinas", seasonal: false, frequency: "baja" },
    { id: "pepperoni", name: "Pepperoni", category: "proteinas", seasonal: false, frequency: "media" },
    { id: "jamon", name: "Jamón", category: "proteinas", seasonal: false, frequency: "alta" },
    { id: "carne_asada", name: "Carne asada", category: "proteinas", seasonal: false, frequency: "alta" },
    { id: "pan_bolillo", name: "Bolillo", category: "cereales", seasonal: false, frequency: "alta" },
    { id: "pan_telera", name: "Telera", category: "cereales", seasonal: false, frequency: "media" },
    { id: "tortilla_grande", name: "Tortilla de harina grande", category: "cereales", seasonal: false, frequency: "media" },
    { id: "marraqueta", name: "Pan Marraqueta", category: "cereales", seasonal: false, frequency: "baja" },
    { id: "masa_madre", name: "Pan de masa madre", category: "cereales", seasonal: false, frequency: "media" },
    { id: "queso_amarillo", name: "Queso amarillo", category: "lacteos", seasonal: false, frequency: "media" },
    { id: "nata", name: "Nata", category: "lacteos", seasonal: false, frequency: "media" },
    { id: "queso_vasterbotten", name: "Queso Västerbotten", category: "lacteos", seasonal: false, frequency: "baja" },
    { id: "beli_sir", name: "Queso Beli Sir", category: "lacteos", seasonal: false, frequency: "baja" },
    { id: "kajmak", name: "Kajmak", category: "lacteos", seasonal: false, frequency: "baja" },
    { id: "guacamole", name: "Guacamole", category: "grasas", seasonal: false, frequency: "alta" },
    { id: "pinon_blanco", name: "Piñón blanco", category: "grasas", seasonal: false, frequency: "baja" },
    { id: "nuez_castilla", name: "Nuez de Castilla", category: "grasas", seasonal: true, frequency: "media" },
    { id: "mayonesa", name: "Mayonesa", category: "basicos", seasonal: false, frequency: "alta" },
    { id: "manteca", name: "Manteca", category: "basicos", seasonal: false, frequency: "media" },
    { id: "harina", name: "Harina", category: "basicos", seasonal: false, frequency: "alta" },
    { id: "chocolate", name: "Chocolate", category: "basicos", seasonal: false, frequency: "media" },
    { id: "vinagre", name: "Vinagre", category: "basicos", seasonal: false, frequency: "alta" },
    { id: "pimienta", name: "Pimienta", category: "basicos", seasonal: false, frequency: "alta" },
    { id: "agua", name: "Agua", category: "basicos", seasonal: false, frequency: "alta" },
    { id: "miel_abeja", name: "Miel de abeja", category: "basicos", seasonal: false, frequency: "alta" },
    { id: "sal_marina", name: "Sal marina", category: "basicos", seasonal: false, frequency: "media" },
    { id: "hierbas", name: "Hierbas", category: "hierbas", seasonal: true, frequency: "media" },
    { id: "cebollin", name: "Cebollín", category: "hierbas", seasonal: true, frequency: "media" },
    { id: "pimiento_morron", name: "Pimiento morrón", category: "verduras", seasonal: true, frequency: "alta" },
    { id: "champiñon", name: "Champiñón", category: "verduras", seasonal: false, frequency: "alta" },
    { id: "cebolla_asada", name: "Cebolla asada", category: "verduras", seasonal: false, frequency: "media" },
    { id: "rábano", name: "Rábano", category: "verduras", seasonal: true, frequency: "media" },
    { id: "leche_almendra", name: "Leche de almendra", category: "lacteos", seasonal: false, frequency: "media" },
    { id: "canela_rama", name: "Canela en rama", category: "basicos", seasonal: false, frequency: "media" },
    { id: "cocoa_polvo", name: "Cocoa en polvo", category: "basicos", seasonal: false, frequency: "media" },
    { id: "semilla_chia", name: "Semilla de chía", category: "grasas", seasonal: false, frequency: "media" },
];
